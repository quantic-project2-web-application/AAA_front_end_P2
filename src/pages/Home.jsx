...
const homeData = {
  hero: {
    ...
    subtitle: "Experience authentic Italian flavors blended with a modern atmosphere in the heart of Washington, DC."
  },
  buttons: [
    {
      text: "View Menu",
  ...
  newsletter: {
    title: "Stay Updated",
    subtitle: "Subscribe to our newsletter for special offers, new menu items, and exclusive events",
...
const NewsletterForm = ({ data, email, setEmail, error, handleSubmit, isSubmitted }) => (
  <div style={{
...
const HomePage = () => {
  ...
  return (
    <main className="home-page" style={{ maxWidth: 1000, margin: '0 auto', padding: 32 }}>
      {/* Hero Section */}
